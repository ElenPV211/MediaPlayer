...
{
    ui->horizontalSliderTrak->setValue(value);
...
{
    ui->horizontalSliderTrak->setMaximum(duration);
...
void Widget::on_horizontalSliderTrak_valueChanged(qint64 position)
{
    m_player->setPosition(position);
}


void Widget::on_horizontalSliderTrak_sliderMoved(int position)
{
    m_player->setPosition(position);
}
